...
INSERT INTO `caja` VALUES (1,'2026-08-20 13:55:55',NULL,150.00,NULL,2,NULL);
...
INSERT INTO `categorias` VALUES (1,'Bebidas','Gaseosas, jugos, cervezas, aguas'),(2,'Abarrotes','Arroz, fideos, conservas, azúcar'),(3,'Limpieza','Detergentes, lejía, escobas'),(4,'Lácteos','Leche, yogurt, mantequilla, queso');
...
INSERT INTO `clientes` VALUES (1,'Señora Rosa','988776655','Av. Siempre Viva 123','2026-08-20 13:55:55'),(2,'Don Pedro','977554433','Calle Los Pinos 456','2026-08-20 13:55:55');
...
INSERT INTO `compras` VALUES (1,1,'2026-08-20 13:55:56',44.00,1);
...
INSERT INTO `detalle_compras` VALUES (1,1,1,10,2.50,25.00),(2,1,2,5,3.80,19.00);
...
INSERT INTO `detalle_ventas` VALUES (1,1,1,1,4.50,4.50),(2,1,4,1,4.80,4.80);
...
INSERT INTO `empresa_configuracion` VALUES (1,'Minimarket Don José','12345678901','Jr. Comercio 742 - Barrio Central','999888777','¡Vuelva pronto!');
...
INSERT INTO `kardex` VALUES (1,1,2,'2026-08-20 13:55:56','SALIDA','VENTA_#1',-1,3.00,20,19),(2,4,2,'2026-08-20 13:55:56','SALIDA','VENTA_#1',-1,3.50,25,24),(3,1,1,'2026-08-20 13:55:56','ENTRADA','COMPRA_#1',10,2.50,19,29),(4,2,1,'2026-08-20 13:55:56','ENTRADA','COMPRA_#1',5,3.80,15,20);
...
INSERT INTO `productos` VALUES (1,'7891000012345','Coca-Cola 1.5L',4.50,29,1,1,'2026-08-20 13:55:55',NULL,'2026-08-20 13:55:56'),(2,'7891000056789','Fideos Don Vittorio 500g',3.20,20,2,1,'2026-08-20 13:55:55',NULL,'2026-08-20 13:55:56'),(3,'7891000098765','Lejía Clorox 1L',5.00,10,3,1,'2026-08-20 13:55:55',NULL,'2026-08-20 13:55:55'),(4,'7891000032100','Leche Gloria 1L',4.80,24,4,1,'2026-08-20 13:55:55',NULL,'2026-08-20 13:55:56');
...
INSERT INTO `proveedores` VALUES (1,'Distribuidora América','Carlos Pérez','987654321',NULL,1,'2026-08-20 13:55:55',NULL,'2026-08-20 13:55:55'),(2,'Inca Foods','María Gómez','912345678',NULL,1,'2026-08-20 13:55:55',NULL,'2026-08-20 13:55:55');
...
INSERT INTO `usuarios` VALUES (1,'Dueño Don José','admin','admin123','ADMIN','2026-08-20 13:55:55'),(2,'Cajero Juan','cajero1','cajero123','CAJERO','2026-08-20 13:55:55');
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ventas` VALUES (1,2,NULL,'2026-08-20 13:55:55',9.30,'EFECTIVO','PAGADO');
...
-- Dump completed on 2026-08-24 15:38:32
